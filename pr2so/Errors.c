...
/*
* Show an Error message in red and finish the application
*/
void Error(char *msg)
{
    ...
    int cerr = write(STDERR_FILENO, infoColorError, strlen(infoColorError));
    exit(errno);
}

/*
* Show a message with the desired color
*/
void printMessage(char *msg, char *color)
{
    ...
    int cerr = write(STDOUT_FILENO, infoColorMsg, strlen(infoColorMsg));
}
